(("undefined"!=typeof globalThis?globalThis:self).makoChunk_antd=("undefined"!=typeof globalThis?globalThis:self).makoChunk_antd||[]).push([["08iSDGHH"],{"08iSDGHH":function(e,t,i){"use strict";i.d(t,"__esModule",{value:!0}),i.d(t,"default",{enumerable:!0,get:function(){return g;}});var r=i("d3__vuQ2"),n=i("8Z0rk4BW"),l=i("WyIMPUJp"),a=r._(i("FDsYADCO")),d=i("ODWitzHB"),s=i("nIblKo9C");a.default.registerNode("behavior-start-node",{draw:(e,t)=>{let i=a.default.Util.getTextSize(e.label,16)[0],r=[i+40,48],n=t.addShape("rect",{name:"start-node",attrs:{width:r[0],height:r[1],y:-r[1]/2,radius:8,fill:"#fff"}});return t.addShape("text",{attrs:{text:`${e.label}`,fill:"rgba(0, 0, 0, 0.88)",fontSize:16,fontWeight:500,x:20,textBaseline:"middle"},name:"start-node-text"}),n;},getAnchorPoints:()=>[[0,.5],[1,.5]]}),a.default.registerNode("behavior-sub-node",{draw:(e,t)=>{let i=a.default.Util.getTextSize(e.label,14)[0],r=[i+32+(e.targetType?12:0)+(e.link?20:0),40],n=t.addShape("rect",{name:"sub-node",attrs:{width:r[0],height:r[1],y:-r[1]/2,radius:8,fill:"#fff",cursor:"pointer"}});if(t.addShape("text",{attrs:{text:`${e.label}`,x:e.targetType?28:16,fill:"rgba(0, 0, 0, 0.88)",fontSize:14,textBaseline:"middle",cursor:"pointer"},name:"sub-node-text"}),e.targetType&&t.addShape("rect",{name:"sub-node-type",attrs:{width:8,height:8,radius:4,y:-4,x:12,fill:"mvp"===e.targetType?"#1677ff":"#A0A0A0",cursor:"pointer"}}),e.children){let{length:i}=e.children;t.addShape("rect",{name:"sub-node-children-length",attrs:{width:20,height:20,radius:10,y:-10,x:r[0]-4,fill:"#404040",cursor:"pointer"}}),t.addShape("text",{name:"sub-node-children-length-text",attrs:{text:`${i}`,x:r[0]+6-a.default.Util.getTextSize(`${i}`,12)[0]/2,textBaseline:"middle",fill:"#fff",fontSize:12,cursor:"pointer"}});}return e.link&&t.addShape("dom",{attrs:{width:16,height:16,x:r[0]-12-16,y:-8,cursor:"pointer",html:`
          ...
          `}}}}},"rect");let o=e=>{let t=(e,i=0)=>{let r={...e};switch(i){case 0:r.type="behavior-start-node";break;case 1:r.type="behavior-sub-node",r.collapsed=!0;break;default:r.type="behavior-sub-node";}return e.children&&(r.children=e.children.map(e=>t(e,i+1))),r;};return t(e);},h=(0,d.createStyles)(({token:e})=>({container:(0,d.css)`
    width: 100%;
    height: 600px;
  ...
  `}));var g=({data:e})=>{let t=(0,l.useRef)(null),{styles:i}=h(),r=(0,s.useRouteMeta)();return(0,l.useEffect)(()=>{let i=new a.default.TreeGraph({container:t.current,width:t.current.scrollWidth,height:t.current.scrollHeight,renderer:"svg",modes:{default:["collapse-expand","drag-canvas"]},defaultEdge:{type:"cubic-horizontal",style:{lineWidth:1,stroke:"#BFBFBF"}},layout:{type:"mindmap",direction:"LR",getHeight:()=>48,getWidth:e=>a.default.Util.getTextSize(e.label,16)[0]+40,getVGap:()=>10,getHGap:()=>60,getSide:e=>e.data.direction}});i.on("node:mouseenter",e=>{i.setItemState(e.item,"hover",!0);}),i.on("node:mouseleave",e=>{i.setItemState(e.item,"hover",!1);}),i.on("node:click",e=>{let{link:t}=e.item.getModel();t&&(window.location.hash=t);}),i.data(o(e)),i.render(),i.fitCenter();},[]),(0,n.jsxs)("div",{ref:t,className:i.container,children:[(0,n.jsx)("div",{className:i.title,children:`${r.frontmatter.title} \u{884C}\u{4E3A}\u{6A21}\u{5F0F}\u{5730}\u{56FE}`}),(0,n.jsxs)("div",{className:i.tips,children:[(0,n.jsx)("div",{className:i.mvp,children:"MVP \u884C\u4E3A\u76EE\u7684"}),(0,n.jsx)("div",{className:i.extension,children:"\u62D3\u5C55\u884C\u4E3A\u76EE\u7684"})]})]});};}}]);
//# sourceMappingURL=08iSDGHH-async.233140a7.js.map